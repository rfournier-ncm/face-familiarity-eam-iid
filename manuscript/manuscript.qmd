...
There is a growing interest in the value of investigating individual differences across the entire spectrum of face recognition ability, and not only by using group-level comparisons between the two extremes (prosopagnosic patients and “super-recognizers”) and average recognizers [@whiteNeedImproveWay2022].
...
This individual difference approach provide an opportunity to investigate the relationships between fundamental processes that are difficult to uncover using group-level analyses.
One key question that association studies have investigated is to what extend individual difference in face processing reflect domain-general differences in other perceptual and cognitive abilities [@mccafferyIndividualDifferencesFace2018; @verhallenGeneralSpecificFactors2017].
Using tests scores as variables of interest, some studies have shown that face and general object perception ability are indeed associated (*r* value ranging from 0.00 to 0.37; @dennettCambridgeCarMemory2012; @richlerIndividualDifferencesObject; @wilmerCapturingSpecificAbilities2012).
...
This model-based analysis of individual differences could provide cleaner measures of the processes of interest and could enhance our understanding on how variation in these latent unobserved processes, which are driving behavior, is related to (@whiteUsingDecisionModels2016).
...
We found that distinct computational processes involved in the decision-making process of face recognition are affect by face familiarity.
